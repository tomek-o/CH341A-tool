...
namespace
{
	void SleepWithMsgProcessing(void)
	{
		Sleep(1);
...
#define checkTimeoutExpired() (io_timeout > 0 && ((GetTickCount() - timeout_start_ms) > io_timeout))
...
{
  last_status = ch341a.I2CWriteCommandWriteByte(address, reg, value);
}

// Write a 16-bit register
void VL53L0X::writeReg16Bit(uint8_t reg, uint16_t value)
{
  last_status = ch341a.I2CWriteCommandWrite2B(address, reg, (uint8_t)(value >> 8), (uint8_t)(value));
}

// Write a 32-bit register
void VL53L0X::writeReg32Bit(uint8_t reg, uint32_t value)
{
  last_status = ch341a.I2CWriteCommandWriteUintFromMsb(address, reg, value);
}
...
{
  uint8_t value;
  ch341a.I2CWriteCommandReadByte(address, reg, value);
  return value;
}
...
uint16_t VL53L0X::readReg16Bit(uint8_t reg)
{
  ...
  ch341a.I2CWriteCommandReadU16FromMsb(address, reg, value);
...
{
  uint32_t value;
  ch341a.I2CWriteCommandReadU32FromMsb(address, reg, value);
  return value;
}
...
{
  last_status = ch341a.I2CWriteCommandWriteBytes(address, reg, src, count);
}
...
{
  ch341a.I2CWriteCommandReadBytes(address, reg, dst, count);
}
